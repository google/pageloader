...
class $Unannotated extends Unannotated with $$Unannotated {
  ...
  String? _privateMethodNullable(String? s) {
    for (final __listener in $__root__.listeners) {
      __listener.startPageObjectMethod('Unannotated', '_privateMethodNullable');
    }
    final returnMe = super._privateMethodNullable(s);
    for (final __listener in $__root__.listeners) {
      __listener.endPageObjectMethod('Unannotated', '_privateMethodNullable');
    }
    return returnMe;
  }

  String? oneParameterNullable(String? privateMe) {
    for (final __listener in $__root__.listeners) {
      __listener.startPageObjectMethod('Unannotated', 'oneParameterNullable');
    }
    final returnMe = super.oneParameterNullable(privateMe);
    for (final __listener in $__root__.listeners) {
      __listener.endPageObjectMethod('Unannotated', 'oneParameterNullable');
    }
    return returnMe;
  }

  int? twoParametersNullable(int? a, int b) {
    for (final __listener in $__root__.listeners) {
      __listener.startPageObjectMethod('Unannotated', 'twoParametersNullable');
    }
    final returnMe = super.twoParametersNullable(a, b);
    for (final __listener in $__root__.listeners) {
      __listener.endPageObjectMethod('Unannotated', 'twoParametersNullable');
    }
    return returnMe;
  }
...
mixin $$Unannotated on Unannotated {
  ...
  dynamic testCreatorInvokeMethodInUnannotated(
    ...
    if (methodName == 'oneParameterNullable') {
      return Function.apply(
          oneParameterNullable, positionalArguments, namedArguments);
    }
    if (methodName == 'twoParametersNullable') {
      return Function.apply(
          twoParametersNullable, positionalArguments, namedArguments);
    }
